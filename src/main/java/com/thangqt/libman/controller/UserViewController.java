...
public class UserViewController {
  ...
  @FXML GridPane userViewContainer;

  @FXML HBox userViewHeadlineContainer;

  @FXML VBox userViewTableContainer;
  ...
  private void showSuccessDialog(User user, String action) {
    ...
    successDialog.setContentText(
        "User " + user.getName() + " has been " + action + " successfully");
    successDialog.show();
  }
...
class UserTableActionCellFactory
    implements Callback<TableColumn<User, String>, TableCell<User, String>> {
    ...
    return new TableCell<User, String>() {
...

      {
        ...
        viewItem.setOnAction(
            event ->
                userViewController.handleViewAction(getTableView().getItems().get(getIndex())));
