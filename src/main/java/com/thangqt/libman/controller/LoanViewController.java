...
public class LoanViewController {
  ...
  @FXML private HBox loanViewHeadlineContainer;
    ...
    try {
      confirmation.setContentText(
          "Loan ID: "
              + loan.getId()
              + "\nTitle: "
              + materialManager.getMaterialById(loan.getMaterialId()).getTitle()
              + "\nBorrower: "
  ...
  class loanStatusCellFactory
      implements Callback<TableColumn<Loan, String>, TableCell<Loan, String>> {
