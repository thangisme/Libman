...
public class MaterialFormView extends ScrollPane {
    ...
    public VBox getTitleContainer() { return titleContainer; }
    public VBox getAuthorContainer() { return authorContainer; }
    public VBox getDescriptionContainer() { return descriptionContainer; }
    public VBox getPublisherContainer() { return publisherContainer; }
    public VBox getIdentifierContainer() { return identifierContainer; }
    public VBox getCoverImageContainer() { return coverImageContainer; }
    public VBox getTotalCopiesContainer() { return totalCopiesContainer; }
    public VBox getAvailableCopiesContainer() { return availableCopiesContainer; }
    ...
    public TextField getIdentifierField() { return identifierField; }
    public TextField getCoverImageField() { return coverImageField; }
    public TextField getTotalCopiesField() { return totalCopiesField; }
    public TextField getAvailableCopiesField() { return availableCopiesField; }
